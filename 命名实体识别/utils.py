...
bert_model = r'bert_wwm_5'
tokenizer = BertTokenizer.from_pretrained(bert_model)
VOCAB = ('<PAD>', '[CLS]', '[SEP]', 'O', 'B-medicine', 'I-medicine','B-use', 'I-use')
...
class NerDataset(Dataset):
    def __init__(self, f_path):
        ...
        for entry in entries:
            words = [line.split()[0] for line in entry.split('\n')]
            tags = ([line.split()[-1] for line in entry.split('\n')])
